...
public class PrimitiveTypesTest {
    ...
    void parityOfLargeNumber() {
        ...
        System.out.printf("Parity of %d = %d%n", n, parityBruteForce(n));

        // 2. Can be optimized to O(k), where k is number of set bits
        System.out.printf("Parity of %d = %d%n", n, parityBasedOnClearingSetBit(n));
        ...
        preComputeParity();
        System.out.printf("Parity of %d = %d%n", n, parityBasedOnCaching(n));

        //4. Using XOR and Shifting operations
        // T(n) = O(logn) where n is the word size
        System.out.printf("Parity of %d = %d%n", n, parityBasedOnXOR(n));
    ...
    void swapBits() {
        ...
        System.out.printf("%d after swapping bits at indices {%d,%d} becomes %d%n", n, i, j, afterSwapBit);
        System.out.printf("Before - %s \nAfter - %s%n", Long.toBinaryString(n), Long.toBinaryString(afterSwapBit));
    }
    ...
    void reverseBits() {
        ...
        System.out.printf("%d after reversing bits - %d%n", n, reverseBits(n));
